...
<ApiTable of="useDataTableOptions" only={["enableGlobalFilter", "enableGlobalFilterModes", "defaultGlobalFilterMode", "globalFilterMode", "onGlobalFilterModeChange", "positionGlobalFilter"]} />
