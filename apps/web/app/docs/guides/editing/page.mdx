...
<ApiTable of="useDataTableOptions" only={["enableEditing", "editDisplayMode", "createDisplayMode", "createRowDefaults", "onEditCellSave", "onSaveRow", "onCreateRow"]} />

Per-column, via `columnDef.meta`:

<ApiTable of="columnOptions" propLabel="meta key" only={["enableEditing", "editVariant", "editSelectOptions", "renderEditCell", "validate"]} />
