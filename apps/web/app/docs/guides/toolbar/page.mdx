...
| Slot                                 | `data-slot`                  |
| ------------------------------------ | ---------------------------- |
| Top toolbar                          | `data-table-toolbar`         |
| Internal actions cluster             | `data-table-toolbar-actions` |
| Selection alert banner               | `data-table-alert-banner`    |
| Bottom toolbar (with custom actions) | `data-table-bottom-toolbar`  |
