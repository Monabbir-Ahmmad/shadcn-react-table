...
## Corpus Check
- 157 files · ~71,259 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1167 nodes · 1978 edges · 83 communities (71 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e70c9a37`
...
Cohesion: 0.06
Nodes (62): DataTableConfigContext, DataTableConfigContextValue, DataTableConfigProvider(), useDataTableConfigContext(), DataTable(), DataTableFilterModeMenu(), createRowActionsColumn(), createExpandColumn() (+54 more)
...
Cohesion: 0.25
Nodes (13): DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioGroup(), DropdownMenuRadioItem(), DropdownMenuSeparator() (+5 more)
...
Cohesion: 0.11
Nodes (25): Skeleton(), Table(), TableBody(), TableCaption(), TableCell(), TableFooter(), TableHead(), TableHeader() (+17 more)
...
Cohesion: 0.06
Nodes (42): Checkbox(), Command(), CommandDialog(), CommandEmpty(), CommandGroup(), CommandInput(), CommandItem(), CommandList() (+34 more)

### Community 13 - "TypeScript Config Presets"
Cohesion: 0.09
Nodes (30): ContextMenu(), ContextMenuCheckboxItem(), ContextMenuContent(), ContextMenuItem(), ContextMenuLabel(), ContextMenuRadioItem(), ContextMenuSeparator(), ContextMenuShortcut() (+22 more)
...
Cohesion: 0.10
Nodes (16): Label(), Popover(), PopoverContent(), PopoverDescription(), PopoverHeader(), PopoverTitle(), PopoverTrigger(), Accent (+8 more)
...
Cohesion: 0.20
Nodes (9): Completed (Phases 1–12), Conventions, Material React Table parity — roadmap, Phase 13 — `table.refs.*` `[M]`, Phase 14 — Display modes `[M–L]`, Phase 15 — `rowPinningDisplayMode` `[L]`, Phase 16 — `enableGlobalFilterRankedResults` `[M]`, Phase 17 — `layoutMode: "grid" | "grid-no-grow"` + column `grow` `[XL]` (+1 more)
...
Cohesion: 0.18
Nodes (11): Badge(), badgeVariants, DataTableColumnActions(), DataTableColumnActionsProps, ALIGN_CLASS, DataTableColumnHeader(), DataTableColumnHeaderProps, DataTableProps (+3 more)
...
## Knowledge Gaps
- **545 isolated node(s):** `metadata`, `geist`, `raleway`, `notoSerif`, `geistMono` (+540 more)
...
- **Why does `cn()` connect `TypeScript Config Presets` to `Feature Set & Roadmap`, `DataTableFilterOption`, `Community 2`, `shadcn Primitives & Styling`, `App Shell & Theming`, `CSV / Excel Export`, `Community 77`, `Column Pinning & Resizing Styles`, `Community 76`, `Community 16`, `Community 80`, `Top Toolbar + Alert Banner + Drop-to-Group Zone`, `getColumnSizeVars`, `IconComponent`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Button()` connect `IconComponent` to `Core Render & Injected Columns`, `Community 2`, `App Shell & Theming`, `CSV / Excel Export`, `TypeScript Config Presets`, `Community 80`, `Community 16`, `Top Toolbar + Alert Banner + Drop-to-Group Zone`, `getColumnSizeVars`?**
